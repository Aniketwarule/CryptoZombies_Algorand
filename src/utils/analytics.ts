      ...
      try {
        ...
        const navigationObserver = new PerformanceObserver((list) => {
          for (const entry of list.getEntries()) {
            ...
            this.trackCustomMetric('dom_content_loaded', navEntry.domContentLoadedEventEnd - navEntry.navigationStart);
            this.trackCustomMetric('page_load_time', navEntry.loadEventEnd - navEntry.navigationStart);
          }
        });
